...
*/
void CSkeletonBasics::StartRecording()
{
	if (!m_bRecording) {
...
* D閙arre et stop la capture de mouvements
*/
void CSkeletonBasics::StopRecording()
{
	if (m_bRecording) {
		m_bRecording = false;
...
*/
void CSkeletonBasics::CalibrateSkeleton(const NUI_SKELETON_DATA &skeleton)
{
	Vector4 offsets[NUI_SKELETON_POSITION_COUNT];
	...
	offset.y = 0;
	offset.z = 0;
	offsets[NUI_SKELETON_POSITION_HIP_CENTER] = offset;

	offset.x = 0;
	offset.y = 6.81f;
	offset.z = 0;
	offsets[NUI_SKELETON_POSITION_SPINE] = offset;

	offset.x = 0;
	offset.y = 36.82f;
	offset.z = 0;
	offsets[NUI_SKELETON_POSITION_SHOULDER_CENTER] = offset;

	offset.x = 0;
	offset.y = 18.49f;
	offset.z = 0;
	offsets[NUI_SKELETON_POSITION_HEAD] = offset;

	offset.x = -14.f;
	offset.y = 0;
	offset.z = 0;
	offsets[NUI_SKELETON_POSITION_SHOULDER_LEFT] = offset;

	offset.x = -25.f;
	offset.y = 0;
	offset.z = 0;
	offsets[NUI_SKELETON_POSITION_ELBOW_LEFT] = offset;

	offset.x = -23.f;
	offset.y = 0;
	offset.z = 0;
	offsets[NUI_SKELETON_POSITION_WRIST_LEFT] = offset;

	offset.x = -8.32f;
	offset.y = 0;
	offset.z = 0;
	offsets[NUI_SKELETON_POSITION_HAND_LEFT] = offset;

	offset.x = 14.f;
	offset.y = 0;
	offset.z = 0;
	offsets[NUI_SKELETON_POSITION_SHOULDER_RIGHT] = offset;

	offset.x = 25.f;
	offset.y = 0;
	offset.z = 0;
	offsets[NUI_SKELETON_POSITION_ELBOW_RIGHT] = offset;

	offset.x = 23.f;
	offset.y = 0;
	offset.z = 0;
	offsets[NUI_SKELETON_POSITION_WRIST_RIGHT] = offset;

	offset.x = 8.32f;
	offset.y = 0;
	offset.z = 0;
	offsets[NUI_SKELETON_POSITION_HAND_RIGHT] = offset;

	offset.x = -9.52f;
	offset.y = 0;
	offset.z = 0;
	offsets[NUI_SKELETON_POSITION_HIP_LEFT] = offset;

	offset.x = 0;
	offset.y = -37.32f;
	offset.z = 0;
	offsets[NUI_SKELETON_POSITION_KNEE_LEFT] = offset;

	offset.x = 0;
	offset.y = -34.6f;
	offset.z = 0;
	offsets[NUI_SKELETON_POSITION_ANKLE_LEFT] = offset;

	offset.x = 0;
	offset.y = 0;
	offset.z = 8.91f;
	offsets[NUI_SKELETON_POSITION_FOOT_LEFT] = offset;

	offset.x = 9.52f;
	offset.y = 0;
	offset.z = 0;
	offsets[NUI_SKELETON_POSITION_HIP_RIGHT] = offset;

	offset.x = 0;
	offset.y = -37.32f;
	offset.z = 0;
	offsets[NUI_SKELETON_POSITION_KNEE_RIGHT] = offset;

	offset.x = 0;
	offset.y = -34.6f;
	offset.z = 0;
	offsets[NUI_SKELETON_POSITION_ANKLE_RIGHT] = offset;

	offset.x = 0;
	offset.y = 0;
	offset.z = 8.91f;
	offsets[NUI_SKELETON_POSITION_FOOT_RIGHT] = offset;
...
//    m_pNuiSensor->NuiTransformSmooth(&skeletonFrame, NULL);
    ...
    for (int i = 0 ; i < NUI_SKELETON_COUNT; ++i)
    {
        ...
        NUI_SKELETON_POSITION_TRACKING_STATE shoulder_center_trackingState = skeletonFrame.SkeletonData[i].eSkeletonPositionTrackingState[NUI_SKELETON_POSITION_SHOULDER_CENTER];
        ...
        if (NUI_SKELETON_TRACKED == trackingState)
        {
			...
			if (NUI_SKELETON_POSITION_TRACKED == shoulder_center_trackingState && !IsRecording())
			{
				OutputDebugString(L"start recording\n");
				StartRecording();
			}

			if (IsRecording() == true && IsCalibrated() == false)
			{
				OutputDebugString(L"calibrate skeleton\n");
				CalibrateSkeleton(skeletonFrame.SkeletonData[i]);
			}

			if (NUI_SKELETON_POSITION_NOT_TRACKED == shoulder_center_trackingState && IsRecording())
			{
				OutputDebugString(L"stop recording\n");
				StopRecording();
			}
